package com.yixin.until;

import com.yixin.pojo.DataList;
import com.yixin.constant.IRespCode;
import com.yixin.pojo.Page;
...
public class CommonJsonUtils {
	...
	public static <T> String page2DataListJson(Page<T> page,
		...
		DataList<T> dl = new DataList<T>(page.getRows(), page.getTotalCount(), apiId);
		return JSON.toJSONString(dl, mapping,SerializerFeature.DisableCircularReferenceDetect);

	}
	
	public static String map2DataListJson(Map<String,Object> map,String apiId){
		if(map==null){
			return null;
		}
		DataList<Map<String,Object>> dl=new DataList<Map<String,Object>>(Arrays.asList(map),0,apiId);
		return JSON.toJSONString(dl, mapping,SerializerFeature.DisableCircularReferenceDetect);
	}
	 ...
	 * @return
	 */
	public static <T> String list2DataListJson(List<T> list, String apiId) {
		if (list == null) {
			return null;
		}
		DataList<T> dl = new DataList<T>(list, list.size(), apiId);
		return JSON.toJSONString(dl, mapping,SerializerFeature.DisableCircularReferenceDetect);
	 ...
	 * @return
	 */
	public static <T> String object2DataListJson(T t, String apiId) {
		if (t == null) {
			return null;
		}
		DataList<T> dl = new DataList<T>(t, apiId);
	...
	public static String basic2DataListJson(Integer code, String message,
		...
		DataList<String> dl = new DataList<String>(code, message, apiId);
		return JSON.toJSONString(dl, mapping);
	}
	...
	public static String createSuccessDataListJson(String apiId){
		return basic2DataListJson(IRespCode.SUCCESS, "", apiId);
	}
